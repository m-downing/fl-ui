...
export const badgeColors = {
  ...
  critical: {
    bg: colors.colors.red[50],
    text: colors.colors.error[500],
  },
  highPriority: {
    bg: colors.colors.yellow[50],
    text: colors.colors.amber[700],
  },
  standard: {
    bg: colors.colors.blue[50],
    text: colors.colors.blue[700],
  },
  atRisk: {
    bg: colors.colors.orange[50],
    text: colors.colors.orange[700],
  },
};
