    ...
    >
      <div className="space-y-4">
        ...
        <div className="border border-neutral-200 rounded-lg overflow-hidden">
          ...
          >
            <h4 className="text-sm font-medium text-neutral-700">Key Contacts ({alert.contacts.length})</h4>
          ...
          >
            ...
            <div className="mb-3">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  <div className="flex justify-between">
                    <p className="text-xs font-medium text-neutral-700">{alert.contacts[0]?.name}</p>
                    <p className="text-xs text-neutral-500">{new Date().toLocaleTimeString()}</p>
                  </div>
                  <div className="mt-1 p-2 bg-neutral-100 rounded-lg">
                    <p className="text-sm">Initial assessment: {alert.message}. Investigating root cause.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-3">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  <div className="flex justify-between">
                    <p className="text-xs font-medium text-neutral-700">{alert.contacts[1]?.name || 'Bob The Builder'}</p>
